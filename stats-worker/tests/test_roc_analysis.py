...
class TestComputeROCCurve:
    ...
    def test_basic_roc(self, binary_classification_data):
        ...
        result = compute_roc_curve(binary_classification_data["y_true"], binary_classification_data["y_score_good"])
    ...
    def test_perfect_classifier(self, perfect_classifier_data):
        ...
        result = compute_roc_curve(perfect_classifier_data["y_true"], perfect_classifier_data["y_score"])
    ...
    def test_random_classifier(self, binary_classification_data):
        ...
        result = compute_roc_curve(binary_classification_data["y_true"], binary_classification_data["y_score_random"])
    ...
    def test_good_vs_poor_model(self, binary_classification_data):
        ...
        result_good = compute_roc_curve(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"]
        )
        result_poor = compute_roc_curve(
            binary_classification_data["y_true"], binary_classification_data["y_score_poor"]
        )
...
class TestCalibrationAnalysis:
    ...
    def test_basic_calibration(self, binary_classification_data):
        ...
        result = analyze_calibration(binary_classification_data["y_true"], binary_classification_data["y_score_good"])
    ...
    def test_hosmer_lemeshow(self, calibrated_model_data):
        ...
        result = analyze_calibration(calibrated_model_data["y_true"], calibrated_model_data["y_score"])
    ...
    def test_calibration_bins(self, binary_classification_data):
        ...
        result = analyze_calibration(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"], n_bins=5
        )
...
class TestPrecisionRecall:
    ...
    def test_perfect_classifier_pr(self, perfect_classifier_data):
        ...
        result = compute_precision_recall(perfect_classifier_data["y_true"], perfect_classifier_data["y_score"])
...
class TestOptimalThreshold:
    ...
    def test_youden_method(self, binary_classification_data):
        ...
        result = find_optimal_threshold(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"], method="youden"
        )
    ...
    def test_f1_method(self, binary_classification_data):
        ...
        result = find_optimal_threshold(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"], method="f1"
        )
...
class TestIntegration:
    ...
    def test_model_selection_workflow(self, binary_classification_data):
        ...
        evaluation = full_classifier_evaluation(y_true, binary_classification_data["y_score_good"])
...
class TestThresholdAnalysis:
    ...
    def test_basic_threshold_analysis(self, binary_classification_data):
        ...
        result = threshold_analysis(binary_classification_data["y_true"], binary_classification_data["y_score_good"])
...
class TestPublicationReport:
    ...
    def test_decimal_places(self, binary_classification_data):
        ...
        result_2 = generate_publication_report(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"], decimal_places=2
        )

        result_3 = generate_publication_report(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"], decimal_places=3
        )
    ...
    def test_threshold_method(self, binary_classification_data):
        ...
        result_youden = generate_publication_report(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"], threshold_method="youden"
        )

        assert "Youden" in result_youden["results_text"]

        result_f1 = generate_publication_report(
            binary_classification_data["y_true"], binary_classification_data["y_score_good"], threshold_method="f1"
        )
