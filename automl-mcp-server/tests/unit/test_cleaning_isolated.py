...
class TestCSVParsing:
    ...
    def test_csv_to_content_roundtrip(self):
        ...
        df1 = pd.DataFrame({"a": [1, 2, 3], "b": ["x", "y", "z"], "c": [1.1, 2.2, 3.3]})
...
class TestBinaryConversion:
    ...
    def test_convert_string_to_binary(self):
        ...
        df = pd.DataFrame({"treatment": ["control", "treatment", "control", "treatment"], "value": [10, 20, 15, 25]})
    ...
    def test_convert_numeric_to_binary(self):
        ...
        df = pd.DataFrame({"dose": [100, 200, 100, 200, 100], "response": [1, 5, 2, 6, 3]})
...
class TestMissingValueHandling:
    ...
    def test_impute_median(self):
        ...
        df = pd.DataFrame({"value": [10, 20, None, 40, 50]})
    ...
    def test_impute_mode(self):
        ...
        df = pd.DataFrame({"category": ["A", "B", "A", None, "A"]})
...
class TestColumnRemoval:
    ...
    def test_remove_multiple_columns(self):
        ...
        df = pd.DataFrame(
            {"id": [1, 2, 3], "name": ["a", "b", "c"], "value": [10, 20, 30], "extra": [True, False, True]}
        )
...
class TestCategoricalEncoding:
    ...
    def test_label_encoding(self):
        """Test label encoding"""
        df = pd.DataFrame({"category": ["cat", "dog", "bird", "cat", "dog"]})
    ...
    def test_encoding_with_unknown_values(self):
        ...
        pd.concat([train["cat"], test["cat"]]).unique()
...
class TestDataFiltering:
    ...
    def test_filter_by_value(self):
        ...
        df = pd.DataFrame({"group": ["A", "B", "A", "B", "C"], "value": [1, 2, 3, 4, 5]})
    ...
    def test_filter_multiple_conditions(self):
        ...
        df = pd.DataFrame({"group": ["A", "A", "B", "B"], "value": [10, 30, 20, 40]})
...
class TestDataTypeConversion:
    ...
    def test_string_to_numeric(self):
        ...
        df = pd.DataFrame({"value": ["10", "20", "30", "NA"]})
    ...
    def test_datetime_parsing(self):
        ...
        df = pd.DataFrame({"date": ["2025-01-01", "2025-02-15", "2025-12-31"]})
